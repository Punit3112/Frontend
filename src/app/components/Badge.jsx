...
const BADGE_CONFIG = {
  top_creator: {
    ...
    fill: "#FFADBB",
    icon: (fill) => (
      <svg viewBox="0 0 512 512" className="w-[13px] mr-[3px]" fill={fill}>
  ...
  responds_fast: {
    label: "Responds Fast",
    tooltip: (name) =>
      `${name} responds to requests faster than most creators.`,
    fill: "#23f35d",
    icon: (fill) => (
      <svg viewBox="0 0 512 512" className="w-[13px] mr-[3px]" fill={fill}>
...
export default function Badge({ type, name }) {
  ...
  return (
    <div className="flex items-end bg-black/70 mr-[5px] rounded-[5px] p-[5px] border border-white cursor-pointer shadow-[rgba(120,120,170,0.3)_0_2px_10px_0]">
      ...
      <div className="invisible w-[230px] bg-[var(--black)] text-white font-normal text-center rounded-[6px] p-[8px] absolute z-[1] top-[20px] left-[-115px] text-[12px] shadow-[rgba(120,120,170,0.15)_0_2px_16px_0]">
        {tooltipText}
      </div>
    </div>
  );
